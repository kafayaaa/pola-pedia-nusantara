...
export default async function BlogDetailPage({
  ...
  return (
    <article className="relative w-full min-h-screen">
      <div className="sticky top-0 z-10 px-10 py-4 md:py-8 w-full flex items-center justify-between bg-brand-white/10 backdrop-blur-sm">
        <div className="flex items-center gap-3">
          <Link href="/admin/blogs">
            <FaArrowLeft className="text-xl md:text-3xl text-brand-dark-gray hover:scale-110 transition-transform" />
          </Link>
          <h1 className="text-2xl md:text-4xl font-extrabold">Blog Detail</h1>
        </div>
        <div className="text-xl md:text-3xl flex items-center gap-4">
      ...
      <div className="md:p-10">
        ...
        <div className="max-w-11/12 md:max-w-3xl mx-auto px-6 pb-20">
